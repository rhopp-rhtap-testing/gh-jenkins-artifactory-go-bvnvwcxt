...
export IMAGE_URL=${IMAGE_URL-artifactory-docker-artifactory-jcr2.apps.rosa.rhtap-services.xmdt.p3.openshiftapps.com/rhtap/gh-jenkins-artifactory-go-bvnvwcxt:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhopp-rhtap-testing/gh-jenkins-artifactory-go-bvnvwcxt-gitops
